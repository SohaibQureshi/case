...
"undefined" != typeof module && module.exports ? module.exports.saveAs = saveAs : "undefined" != typeof define && null !== define && null !== define.amd && define("FileSaver.js", function() {
    ...
    function e(e, n) {
        clearTimeout(d), $(".messages .message").length > 0 ? $(".messages .message").stop().fadeOut(400, function() {
            $(this).remove(), t(e, n)
        }) : t(e, n)
    }

    function t(e, t) {
        $(".messages").append('<div class="message ' + t + '">' + e + "</div>").hide().fadeIn(400), d = setTimeout(function() {
    ...
    if (1 == $("#content").length) {
        $("#content").focus(), $("#upper").click(function() {
            ...
            return $("#content").val(n($("#content").val())).focus(), $("#content").attr("placeholder", n($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Sentence", "", $(".word_count").text()), !1
        ...
        try {
            ...
            $("#download").show().click(function() {
                if (0 == $("#content").val().length) e(no_text, "error");
                    ...
                    }), file_name), e(downloaded, "success"), "function" == typeof ga && ga("send", "event", "Download", "Download", "", $(".word_count").text())
                }
                return !1
            })
        } catch (e) {}
    ...
    "y" != function(e) {
        ...
        e.preventDefault(), $(".cookiebar").slideUp(), f("ACCEPTCONSENT", "y", 365, "/")
    }))
